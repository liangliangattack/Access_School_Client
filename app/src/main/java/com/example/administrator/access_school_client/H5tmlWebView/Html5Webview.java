 ...
 * Administrator on 2018/7/30 12:51.
 */
...
//                if (Uri.parse(url).getHost().equals("www.example.com")) {
                    ...
                    Log.d("ssssssssssssssdo","baidu"+"");
                    //Toast.makeText(context, "网址是："+Uri.parse(url).getHost(), Toast.LENGTH_SHORT).show();
                    return false;
//                } else {
//                    //跳转外部浏览器
//                    Intent intent = new Intent(Intent.ACTION_VIEW, uri);
//                    Toast.makeText(context, "22222222222", Toast.LENGTH_SHORT).show();
